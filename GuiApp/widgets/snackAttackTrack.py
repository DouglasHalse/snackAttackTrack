...
from widgets.patronRow import PatronRowWidget
from widgets.deviceRow import DeviceRowWidget
from widgets.popups.managePatronsPopup import ManagePatronsPopup
...
class SnackAttackTrackWidget(BoxLayout):
    ...
    def RemoveDeviceInfoWidget(self, deviceName):
        for deviceRowWidget in self.ids.deviceList.children:
            if (
                deviceRowWidget.baseDeviceInfoWidget.labelWidget.ids.deviceName.text
                == deviceName
            ):
    ...
    def OnManagePatronsButtonPressed(self):
