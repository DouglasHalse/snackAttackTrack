...
class ManageDevicePopup(Popup):
    ...
    def OnConfirmButtonPressed(self):
        ...
        # or self.ids.manageDeviceTypeSpinner.text !=
        # SpookStationDeviceTypeToString[self.deviceType]:
        if self.ids.manageDeviceNameInput.text != self.deviceName:
            ...
            self.manageDevicesAddedDevice.ids.manageDeviceAddedDeviceName.text = (
                self.ids.manageDeviceNameInput.text
            )
            self.manageDevicesAddedDevice.ids.manageDeviceAddedDeviceType.text = (
                self.ids.manageDeviceTypeSpinner.text
            )
        self.dismiss()
    ...
    def OnRemoveButtonPressed(self):
        ...
        self.manageDevicesPopup.ids.manageDevicesAddedDevicesGridListContent.remove_widget(
            self.manageDevicesAddedDevice
        )
...
class ManageDevicesPopupDevice(BoxLayout):
    def __init__(
        self, spookStationWidget, manageDevicesPopup, deviceName, deviceType, **kwargs
    ):
        self.spookStationWidget = spookStationWidget
        self.manageDevicesPopup = manageDevicesPopup
        super().__init__(**kwargs)
    ...
    def OnManageDeviceButtonPressed(self, deviceName: str):
        # deviceType = deviceManager.devices[deviceName].deviceType
        manageDevicePopup = ManageDevicePopup(
            spookStationWidget=self.spookStationWidget,
            manageDevicesPopup=self.manageDevicesPopup,
            manageDevicesAddedDevice=self,
